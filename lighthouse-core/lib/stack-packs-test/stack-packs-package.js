...
/** @type {Object<string, Pack>} */
const stackPacks = {
  wordpress: {
    id: 'wordpress',
    iconDataURL: wordpressIcon,
    title: 'WordPress',
    descriptions: require('./wordpress.json').reduce((descriptions, audit) => {
      return Object.assign({}, descriptions, {[audit.id]: audit.secondaryDescription});
    }, {}),
  },
};
